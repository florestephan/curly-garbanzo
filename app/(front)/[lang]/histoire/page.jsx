        ...
        <main>
            ...
            <section className="about bg-BlackP">
                <div className="gridCtn pt-20 pb-32">
                    ...
                    <TitleTxtCta
                        ...
                        className="[&>a>span:last-child]:bg-Black col-start-7 col-end-11 text-white mobile:col-span-12 mobile:pt-10"
                    />
            ...
            <section className="my-20">
                <div className="relative gridCtn">
                    ...
                    <TitleTxtCta
                        ...
                        className="[&>a>span:last-child]:bg-GreyM absolute h-full col-start-4 col-end-10 text-Black w-full items-center justify-center text-center mobile:col-span-12 mobile:static"
                    />
                </div>
            </section>
            ...
            <section className="border-t-[1px] border-GreyBlue text-Black mb-24">
                <TitleTxtCta
                    ...
                    className="[&>a>span:last-child]:bg-GreyM text-center pt-40 pb-24 items-center justify-center w-full mobile:col-span-12 mobile:px-4"
                />
            </section>
        </main>
    )
